...
166종목 3년치로 검증했다. 낙관적 비용(5bp)에서도 일평균 +0.12%/샤프 1.40으로 국내(+0.28%/3.7)보다 약했고
현실적인 미국 환전+수수료(20bp 이상)에서는 마이너스로 뒤집혔다 (연환산 -10~-30%, 최대낙폭 최대 -67%).
미국은 국내와 달리 장중도 평균 플러스라 "당일 급등주 고르기"가 시장 평균 대비 알파를 주지 못했다.
페이퍼/실전 배포하지 않는다. 코드(`overseas/`, `kiwoom.client.us_*`)는 다른 신호를 시도할 때 쓰려고 남겨둔다.
